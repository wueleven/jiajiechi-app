...
.bind-status-bar { display: flex; gap: 10px; margin-bottom: 14px; flex-wrap: nowrap; }
.bind-tag { display: flex; align-items: center; gap: 5px; padding: 5px 12px; border-radius: 20px; font-size: 11px; flex-shrink: 0; white-space: nowrap; }
